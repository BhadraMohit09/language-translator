...
import { HiOutlineGlobeAlt, HiOutlinePencilAlt, HiOutlineSparkles } from 'react-icons/hi';
  ...
  return (
    <div className="translator-wrapper">
        ...
        <div className="translator-card">
          ...
          <div className="controls">
            ...
            <button className="translate-btn" onClick={handleTranslate}>
              <MdTranslate style={{ marginRight: '6px' }} />
              Translate
            </button>
          ...
          {result && (
            <div className="result-box">
              <h4>
                <GiArtificialHive style={{ marginRight: '6px' }} />
                Translated Text:
              </h4>
      ...
      <div className="footer-credit">
        ...
        Developed by <strong>Bhadra Mohit</strong>
      </div>
